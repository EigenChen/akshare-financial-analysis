...
# 动态导入 core/a_share/annual_report_downloader.py 模块
spec = importlib.util.spec_from_file_location("download_report", ROOT / "core/a_share/annual_report_downloader.py")
