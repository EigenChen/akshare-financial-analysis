...
def test_main_program_integration():
    ...
    print("\n1. 测试智能模块加载...")
    try:
        emp_module = load_module("employee_extractor", str(ROOT / "core/a_share/employee_extractor.py"))
...
def test_streamlit_compatibility():
    ...
    try:
        ...
        if "core/a_share/employee_extractor.py" in content:
...
def main():
    ...
    print(f"\n状态更新:")
    print("- 主程序现在会加载 'core/a_share/employee_extractor.py' 而非旧模块")
